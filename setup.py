...
def _build_vgm_play(build_temp, build_lib):
  ...
  urllib.urlretrieve(
      'https://github.com/vgmrips/vgmplay-legacy/archive/refs/heads/master.tar.gz',
      tgz_filepath)
  ...
  vgmplay_dir = os.path.join(build_temp, 'vgmplay-legacy-master', 'VGMPlay')
  ...
  if made_build_temp:
    ...
    shutil.rmtree(os.path.join(build_temp, 'vgmplay-legacy-master'))
